...
SetMonth using month and year dropdown selection calendar
    ...
    DropDown            3                         //div[@class\='ui-datepicker-header ui-widget-header ui-helper-clearfix ui-corner-all']//div[@class\='ui-datepicker-title']//select[@class\='ui-datepicker-month']//option[text()\='Mar']
    Sleep               3s
